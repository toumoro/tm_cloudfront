...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:tm_cloudfront/Resources/Private/Language/locallang_db.xlf:tx_tmcloudfront_domain_model_invalidation',
        'label' => 'pathsegment',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, pathsegment',
    ],
    'types' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_tmcloudfront_domain_model_invalidation',
                'foreign_table_where' => 'AND tx_tmcloudfront_domain_model_invalidation.pid=###CURRENT_PID### AND tx_tmcloudfront_domain_model_invalidation.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
